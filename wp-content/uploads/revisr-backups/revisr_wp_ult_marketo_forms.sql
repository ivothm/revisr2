...
DROP TABLE IF EXISTS `wp_ult_marketo_forms`;
...
LOCK TABLES `wp_ult_marketo_forms` WRITE;
/*!40000 ALTER TABLE `wp_ult_marketo_forms` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_ult_marketo_forms` ENABLE KEYS */;
UNLOCK TABLES;
