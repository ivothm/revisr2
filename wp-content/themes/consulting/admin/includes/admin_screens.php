...
/*System status*/
function stm_theme_admin_wpml_page() {
	stm_startup_templates('wpml');
}
...
function stm_get_admin_tabs($screen='welcome') {
	...
	<h2 class="nav-tab-wrapper">
	    <?php if ( !defined('ENVATO_HOSTED_SITE') ): ?>
            ...
            <a href="<?php echo ( 'wpml' === $screen ) ? '#' : esc_url_raw( admin_url( 'admin.php?page=' . $theme_name_sanitized . '-wpml' ) ); ?>" class="<?php echo ( 'wpml' === $screen ) ? 'nav-tab-active' : ''; ?> nav-tab"><?php esc_attr_e( 'WPML Installer', 'consulting' ); ?></a>
